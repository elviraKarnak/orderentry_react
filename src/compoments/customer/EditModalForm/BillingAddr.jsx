...
function BillingAddr(props) {
  ...
  const getStatesByCountryIdFirst = async (country_id) => {
    ...
    // console.log(props.CustomerData.bill_addr.bill_state_id);
    setValue("bill_state_id",props.CustomerData.bill_addr.bill_state_id);
    setChkForm(true)
  }
  ...
  useEffect(() => {
    ...
    if (props.CustomerData != null) {
      ...
      getStatesByCountryIdFirst(props.CustomerData.bill_addr.bill_country_id);

      if(props.CustomerData?.bill_addr)
      {
        // setValue("bill_state_id",props.CustomerData.bill_addr.bill_state_id);
      }
    }
  ...
  // useEffect(()=>{
  //   if(State.length>0){
  //     alert(props.CustomerData.bill_addr.bill_country_id)
  //     setValue("bill_state_id",props.CustomerData.bill_addr.bill_state_id);
  //   }
  // },[State])
