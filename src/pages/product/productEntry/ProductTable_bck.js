...
function ProductTable() {
    ...
    () => [
      {
        ...
        Header: ({ column }) => (
          <i style={{ color: "#aaa" }}>
            <ImageIcon />
          </i> //re-use the header we already defined
        ),
        enableEditing: true,
        type: "file",
        size: 30,
        Cell: ({ renderedCellValue, row }) => (
          <>
            ...
            <img
              src={
                renderedCellValue == "images/noimage.jpg"
                  ? placeholderImage
                  : renderedCellValue
              }
              alt=""
  ...
  const handleProductAdd = async ({ values, table }) => {
    // console.log("handleProductAdd ", values, table);
    ...
    // const newValidationErrors = validateUser(newRowData);
...
function validateUser(user) {
  ...
  return {
    ...
    cost_price: !validateRequired(user.cost_price)
    ...
    postpublishdate: !validateRequired(user.postpublishdate)
      ? "This field is Required"
      : "",
    preorder: !validateRequired(user.preorder) ? "This field is Required" : "",
    real_price: !validateRequired(user.real_price)
      ? "This field is Required"
      : "",
    real_stock: !validateRequired(user.real_stock)
      ? "This field is Required"
      : "",
