...
// login submit
    const onLoginFormSubmit = (e) => {
      ...
      loginPasswoard === "" ? setrequiredLoginPassword("visiable") : setrequiredLoginPassword("hidden");
      ...
      async function getLoginResponse() {
        const fetcLoginResponse = await fmiOrderSystemAppAppLogin(loginEmail,loginPasswoard);
          ...
          <Typography component="h2">Login</Typography>
            ...
            <FormControl  className="formControl">
              ...
              <FormHelperText className={requiredLoginEmail}>
                <span className="requiredError">{requiredErrorMessage}</span>
              </FormHelperText>
