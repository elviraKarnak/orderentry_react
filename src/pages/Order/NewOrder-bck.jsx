...
import { fmiOrderSystemAppOrderAdd, fmiOrderSystemAppProductOrderEntrySearch } from "../../utils/fetch";
            ...
            <Container>
                ...
                <div className="order-total-table">
                    ...
                    <div className="add-line-item">
                        ...
                        <Button onClick={ProductList}> <img src={AddCircleOut} alt="" /> {" "}Add a line item </Button>
                                    ...
                                    <tbody>
                                        ...
                                        {userState.ProductData.length > 0 && userState.ProductData.map((item, index) => (<>
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <img src={item.product_details.image_url} alt="" onClick={() => setImageShowModalUrl(item.product_details.image_url)} />
                                                </td>
